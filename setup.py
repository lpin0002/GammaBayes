...
setup(name='GammaBayes',
      ...
      package_data={
          'gammabayes':['package_data/gll_iem_v06_gc.fits.gz', 
                        ...
                        'package_data/irf_fits_files/prod5/CTA-Performance-prod5-v0.1-South-20deg.FITS.tar.gz',
                        'package_data/irf_fits_files/prod5/CTA-Performance-prod5-v0.1-North-20deg.FITS.tar.gz',
                        # 'package_data/irf_fits_files/prod3b/*',
                        'dark_matter/channel_spectra/PPPC_Tables/*.dat',
                        'dark_matter/spectral_models/Z2_ScalarSinglet/annihilation_ratio_data/annihilation_ratios__dimauromattia.csv',
