...
class hyperparameter_likelihood(object):
    ...
    def observation_marg_efficient(self, axisvals, signal_prior_matrices, logbkgpriorvalues):
    ...
    def observation_marg(self, axisvals, signal_prior_matrices, logbkgpriorvalues):
        ...
        likelihoodvalues = likelihoodvalues - psfnormvalues - edispnormvalues
        ...
        for logmass_idx, signal_prior_matrix in enumerate(signal_prior_matrices):
            ...
            output = logsumexp(signal_prior_matrix+self.dependent_logjacob+likelihoodvalues)#-irfnormalisation)
            singlemass_sigmargvals.append(output)
