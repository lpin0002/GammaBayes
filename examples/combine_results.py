...
xi_lowerbound       = inputs['signalfraction']-xi_windowwidth
xi_upperbound       = inputs['signalfraction']+xi_windowwidth
...
xi_range            = np.linspace(xi_lowerbound, xi_upperbound, inputs['nbins_signalfraction']) 
