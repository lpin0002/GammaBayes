...
class ScanOutput_StochasticStickingBreakingMixturePosterior(object):
    """
    A class designed to handle stochastic exploration of posterior distributions for stick-breaking 
    mixture fractions using the Dynesty nested sampling package.
